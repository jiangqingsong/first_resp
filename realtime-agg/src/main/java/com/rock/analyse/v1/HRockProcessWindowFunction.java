...
public class HRockProcessWindowFunction extends ProcessWindowFunction<AnalysePojoV1, AnalysePojoV1, String, TimeWindow> {
    ...
    public void process(String s, Context context, Iterable<AnalysePojoV1> elements, Collector<AnalysePojoV1> out) throws Exception {
        ...
        context.output(RockConstants.DAY_OUTPUT_TAG, analysePojoV1);
